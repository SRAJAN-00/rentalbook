  ...
  return (
    <div className="max-w-2xl mx-auto p-8">
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <p className="text-gray-600 mb-6">Manage your book database with seed and clear operations</p>
        ...
        <div className="mt-6 text-sm text-gray-500">
          <p><strong>Seed:</strong> Adds 18 books to the database (if empty)</p>
          <p><strong>Clear:</strong> Removes all books from the database</p>
        </div>
      </div>
    </div>
  );
